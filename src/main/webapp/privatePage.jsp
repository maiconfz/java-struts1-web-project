...
<body>
    ...
    <main class="container">
        <h1>Private Page - MyApp</h1>
        
       	<div class="text-center mt-4">
	        <button class="btn btn-primary">
	            <span class="glyphicon glyphicon-log-in"></span> Private Page
	        </button>
	    </div>
