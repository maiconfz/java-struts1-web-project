...
<body>
    ...
    <main class="container text-center">
        ...
        <div class="row">
            ...
            <div class="col-xs-6 text-center">
                <a class="btn btn-default btn-lg" href="${contextPath}/companies.do" title="Go to companies management area" style="font-size: 6rem"> <i class="fa fa-building" aria-hidden="true"></i><br />
