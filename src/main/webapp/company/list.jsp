...
<body>
	...
	<main class="container">
							...
							<tr>
								...
								<td class="text-right">
									<div class="btn-group" role="group" aria-label="...">
										<a href="${contextPath}/company/save.do?companyId=${company.id}"
											class="btn btn-sm btn-default"
											title='Edit company "${company.name}"'><i
											class="fa fa-pencil" aria-hidden="true"></i></a> <a
											href="${contextPath}/company/company-delete.do?companyId=${company.id}"
											class="btn btn-sm btn-danger"
											title='Delete company "${company.name}"'><i
		...
		<a class="btn btn-primary" href="${contextPath}/company/save.do"
			title="Create new company">New</a>
	</main>
	<!-- /container -->
