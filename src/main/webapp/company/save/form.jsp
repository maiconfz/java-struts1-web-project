        ...
        <div class="row">
            <div class="col-xs-12 col-md-4">
                <form id="company-save-form" action="${contextPath}/company/save.do" method="POST">
                    ...
                    <div class="form-group ${actionErrors.get('vat').hasNext() ? 'has-error' : (validated ? 'has-success' : '')}">
                        <label for="company-vat">Vat</label>
                        <input id="company-vat" type="text" class="form-control" name="vat" value="${form.vat}" placeholder="Vat" aria-label="Vat" required />
                        <div class="help-block">
                            <html:errors property="vat" />
                        </div>
                    </div>
