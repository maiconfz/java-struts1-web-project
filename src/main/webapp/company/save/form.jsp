            ...
            <div class="col-xs-12 col-md-4">
                <form id="company-save-fome" action="${contextPath}/company/save.do" method="POST">
                    ...
                    <div class="form-group ${actionErrors.get('address').hasNext() ? 'has-error' : (validated ? 'has-success' : '')}">
                        ...
                        <input id="company-address" type="text" class="form-control" name="address" value="${form.address}" placeholder="Address" aria-label="Address" maxlength="255" required />
                        <div class="help-block">
 					...
 					<div class="form-group ${actionErrors.get('vatNumber').hasNext() ? 'has-error' : (validated ? 'has-success' : '')}">
                        <label for="company-vatNumber">VAT Number</label>
                        <input id="company-vatNumber" type="text" class="form-control" name="vatNumber" value="${form.vatNumber}" placeholder="VAT Number" aria-label="VAT Number" maxlength="15" required />
                        <div class="help-block">
