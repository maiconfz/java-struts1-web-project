        ...
        <div class="row">
            <div class="col-xs-12 col-md-4">
                <form id="company-save-form" action="${contextPath}/company/save.do" method="POST">
                    ...
                    <input type="hidden" id="company-original-username" name="originalUsername" value="${form.originalUsername}" />
                    ...
                    <div class="form-group ${actionErrors.get('address').hasNext() ? 'has-error' :  (validated ? 'has-success' : '')}">
                        ...
                        <input id="company-address" type="text" class="form-control" name="address" value="${form.address}" placeholder="Address" aria-label="Address" maxlength="100" required />
                        <div class="help-block">
                            <html:errors property="address" />
                        </div>
                    </div>
                    
                    <div class="form-group ${actionErrors.get('ivaNumber').hasNext() ? 'has-error' :  (validated ? 'has-success' : '')}">
                        <label for="company-ivaNumber">IVA Number</label>
                        <input id="company-ivaNumber" type="text" class="form-control" name="ivaNumber" value="${form.ivaNumber}" placeholder="IvaNumber" aria-label="IvaNumber" maxlength="100" required />
                        <div class="help-block">
                            <html:errors property="ivaNumber" />
                        </div>
                    </div>
