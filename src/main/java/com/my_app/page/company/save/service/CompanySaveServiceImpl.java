	...
	public boolean validate(CompanySaveForm form) {
		...
		if (StringUtils.isBlank(form.getName())) {
			...
			form.getActionErrors().add("name", new ActionMessage("error.common.required"));
				...
				&& !form.getOriginalName().equals(CompanyUtils.normalizeCompanyName(form.getName()))))
		...
		if (StringUtils.isBlank(form.getVatNumber())) {
			isValid = false;
			form.getActionErrors().add("vatNumber", new ActionMessage("error.common.required"));
		}
